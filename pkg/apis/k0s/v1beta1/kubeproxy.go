...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.35.3/config/v1alpha1/types.go#L27-L48
...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.35.3/config/v1alpha1/types.go#L52-L78
...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.35.3/config/v1alpha1/types.go#L82-L97
